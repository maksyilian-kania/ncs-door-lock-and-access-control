...
unmodified across capture sizes. Frames are single-channel grayscale, as
captured by the SPI camera driver (see spi_cam_fifo_read_gray() in
drivers/camera/spi_cam/src/spi_cam.c) - there is no RGB data to show.
